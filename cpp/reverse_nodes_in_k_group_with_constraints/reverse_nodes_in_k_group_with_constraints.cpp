...
void runTests() {
    ...
    std::cout << "输出: ";
    printList(result1);
    std::cout << "期望: 3 -> 2 -> 1 -> 0 -> 6 -> 5 -> 4" << std::endl << std::endl;
    deleteList(result1);
    ...
    std::cout << "输出: ";
    printList(result2);
    std::cout << "期望: 1 -> 1 -> 1 -> 9 -> 2 -> 2 -> 2" << std::endl << std::endl;
    deleteList(result2);
    ...
    std::cout << "输出: ";
    printList(result3);
    std::cout << "期望: 5" << std::endl << std::endl;
    deleteList(result3);
}
...
int main() {
    ...
    std::cout << "空间复杂度: O(1)" << std::endl << std::endl;
